...
<Info>
  **Getting Started**
  ...
  Learn more about how open auction line items work with our API [**here**](/retail-media/v2024.10/docs/onsite-sponsored-products)!
</Info>
...
<ResponseField name="bidStrategy">
**Data Type:** enum
...
<ResponseField name="targetBid" required>
**Data Type:** number
