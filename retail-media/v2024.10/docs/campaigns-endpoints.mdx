...
<ResponseField name="accountId" required>
**Data Type:** string
...
<ResponseField name="clickAttributionWindow" required>
**Data Type:** enum
...
<ResponseField name="viewAttributionWindow" required>
**Data Type:** enum
...
<ResponseField name="clickAttributionScope">
**Data Type:** enum
...
<ResponseField name="viewAttributionScope">
**Data Type:** enum
...
<ResponseField name="drawableBalanceIds">
...
**Description:** Campaign status, derived from the status of [line items](/retail-media/docs/line-items) it holds; active if at least one line item is active. To understand the conditions that will cause a status to change, check out our [status page](/retail-media/docs/campaigns#status)
...
<ResponseField name="monthlyPacing">
**Data Type:** decimal
...
<ResponseField name="dailyPacing">
**Data Type:** decimal
...
<ResponseField name="isAutoDailyPacing" required>
**Data Type:** boolean
