...
- **Commerce Max — Retailer Budgets Expansion** — Retailer budget management is now fully supported in stable, covering budget visibility, field naming, and eligibility rules across campaigns, line items, and balances. Explore the [Retailer-billed Balances](/retail-media/docs/balances#retailer-billed-balances) section of the Balances guide for more information.
