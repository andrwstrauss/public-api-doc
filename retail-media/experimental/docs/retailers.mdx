...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026-preview/docs/Migrated to stable (2026.01)/retailers.md
hidden: true
---
...
A retailer typically allows multiples types of pages to be targeted. A _page_ is an inventory that can be targeted by [Campaigns](/retail-media/v2025.07/docs/campaign) and  [Line Items](/retail-media/experimental/docs/line-items) with specific configurations.
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     Budget models supported for this
     <code>
      buyType
     </code>
     x
    ...
    <p>
     ...
     . Presence of a value indicates that budget model is available. Learn more about retailer-billed balances <a href="/retail-media/docs/balances#retailer-billed-balances">here</a>.
    </p>
    <p>
...
Results are paginated using `offset` and `limit` query parameters; if omitted, defaults to `0` and `5`, respectively. See [API Response](/retail-media/experimental/docs/api-response#pagination).
...
```http
https://api.criteo.com/experimental/retail-media/accounts/{accountId}/retailers/search
```
</EndpointBadge>
...
```bash cURL
curl -X POST "https://api.criteo.com/experimental/retail-media/accounts/18446744073709551616/retailers/search?offset=0&limit=5" \
...
url = "https://api.criteo.com/experimental/retail-media/accounts/18446744073709551616/retailers/search?offset=0&limit=5"
...
$request->setUrl('https://api.criteo.com/experimental/retail-media/accounts/18446744073709551616/retailers/search?offset=0&limit=5');
                ...
                "campaignAvailabilities": [
                    {
                        ...
                        "buyType": "auction",
                        "budgetModelAvailabilities": ["criteoBudget", "retailerBudget"],
                        "validCombinations": [
                            {
                                "pageType": "home",
                    ...
                    },
                    {
                        ...
                        "budgetModelAvailabilities": ["retailerBudget"],
                        "validCombinations": [
                            {
                                "pageType": "home",
                                "pageEnvironmentType": "web"
                    ...
                    },
                    {
                        "campaignType": "onsiteDisplay",
                        "buyType": "sponsorship",
                        "budgetModelAvailabilities": null,
                        "validCombinations": []
                    },
                    {
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     API user does not have the authorization to make requests to the account ID. For an authorization request, follow the <a href="/retail-media/experimental/docs/authorization-requests">authorization request</a> steps
    </p>
   </td>
  </tr>
 </tbody>
