...
A retailer typically allows multiples types of pages to be targeted. A **page** is an inventory that can be targeted by [Campaigns](/retail-media/docs/campaigns) and  [Line Items](/retail-media/docs/line-items) with specific configurations.
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     combination at this retailer. Presence of a value indicates that budget model is available; an empty array means the combination is not available.
    </p>
    <p>
     Values:
     <code>
     ...
     . Learn more about retailer-billed balances <a href="/retail-media/docs/balances#retailer-billed-balances">here</a>.
    </p>
    <p>
...
Results are paginated using `offset` and `limit` query parameters; if omitted, defaults to `0` and `5`, respectively. See [API Response](/criteo-apis/docs/api-response#pagination).
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     API user does not have the authorization to make requests to the account ID. For an authorization request, follow the <a href="/criteo-apis/docs/authorization-requests">authorization request</a> steps
    </p>
   </td>
  </tr>
 </tbody>
