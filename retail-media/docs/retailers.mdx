...
| 🔴`403`  | API user does not have the authorization to make requests to the account ID. For an authorization request, follow the steps indicated here: [authorization request](/retail-media/docs/authorization-requests) |
