...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/Guides for Retail Media API/supply-side-reporting-ssp/revenue-report-ssp.md
...
When a retailer wants to view their default settings (as used in the user interface), we suggest constructing their API request or data call using the same default parameters as in the UI.

For Onsite Sponsored Products:
...
* `viewMatchLevel`: `sameCategory`

<Note>
  For more information on the report, please visit the [Criteo Help Center.](https://help.retailmedia.criteo.com/kb/guide/en/supply-side-dashboard-kAQBtSzLkH/Steps/3155149)
</Note>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <p>
     _Note: when metrics and dimensions are used, the report type is ignored._
    </p>
    <p>
     Accepted values:
     <code>
  ...
  <tr>
   ...
   <td>
    ...
    <p>
     ...
     <a href="/retail-media/docs/metrics-and-dimensions-ssp">
  ...
  <tr>
   ...
   <td>
    ...
    <p>
     _This is not a filter that excludes events. Rather, it calculates attribution using the provided SKU match level._
    </p>
    <p>
     Accepted values:
     <code>
  ...
  <tr>
   ...
   <td>
    ...
    <p>
     _There are currently no limitations to the amount of IDs that can be added to the filter._
    </p>
   </td>
  </tr>
  <tr>
...
<Info>
  **Metrics and Dimensions**
  ...
  For a complete list of all supported metrics and dimension, check out the [Metrics and Dimensions](/retail-media/docs/metrics-and-dimensions-ssp)
</Info>
...
_Report broken down by advertiser by JSON format_
