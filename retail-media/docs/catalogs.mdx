...
A [line item](/retail-media/docs/line-items) selects the products it promotes from the account's catalog — what's synced here determines what a line item can advertise. See the [Campaign Management Overview](/retail-media/docs/campaign-management-overview) for how the catalog fits into the wider entity model.
