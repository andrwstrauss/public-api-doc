...
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/Guides for Retail Media API/line-items/onsite-sponsored-products/bid-multipliers.md
---
...
<Warning>
  This endpoint returns all possible page types supported by our platform, including the ones not currently supported by the respective retailer associated with the line item. For the effective list of supported page types, please refer to [Retailers](/retail-media/v2025.07/docs/retailers)
</Warning>
...
<Warning>
  A **`PUT`** operation with empty attributes object will reset all values to their default values.
</Warning>
...
* [Budget Overrides](/retail-media/docs/line-items#budget-overrides)
