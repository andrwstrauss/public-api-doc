 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <p>
     For more details about each state, see <a href="/retail-media/docs/line-items#lifecycle">Line Item status</a>. Pausing or unpausing a product does not change the status of its line item or campaign.
    </p>
    <p>
     Returned values:
     <code>
