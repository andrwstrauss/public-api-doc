---
title: Minimum Bid
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/Guides for Retail Media API/line-items/onsite-sponsored-products/minimum-bid.md
---

## Introduction

1. An [Onsite Sponsored Products](/retail-media/docs/line-items) line item holds promoted products to advertise on a single retailer.
...
4. Products SKU IDs are available through [Catalog](/retail-media/docs/catalogs) endpoints.
...
* [Demand Side Analytics (DSP)](/retail-media/docs/analytics)
