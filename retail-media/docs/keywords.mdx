---
title: Keywords
original_file: to-migrate/criteo-dev-portal-full-export/merged_export/Retail_Media/v2026_01/docs/Guides for Retail Media API/line-items/onsite-sponsored-products/keywords.md
---
...
<Info>
  The `keywords` endpoints allows you to control your Onsite Sponsored Products line item by providing visibility to users on **what keyword(s) are applied to line items**. This allows to determine which keyword(s) to target positively or negatively.

  The endpoint can also provide **keyword bidding capabilities** to optimize line items based on relevant keywords.

  Visit the [**Line Items**](/retail-media/docs/line-items) page for a complete summary of Criteo's keyword service.
</Info>
  ...
  <tr>
   ...
   <td>
    ...
    <p>
     ...
     <a href="/retail-media/docs/catalog-endpoints">
      Catalog Endpoints
     </a>
     and
     <a href="/retail-media/docs/onsite-display-line-itemsv2">
...
Bids can be set on a keyword at any time, even when the keywords are still  in the`InReview` state
...
* [Keyword Review](/retail-media/docs/keyword-review)
