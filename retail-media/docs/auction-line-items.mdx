...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    <p>
     Start date of the line item, used to schedule its activation and start serving ads. To understand the conditions that will cause a status to change, see <a href="/retail-media/docs/line-items#lifecycle">Line Item status</a>
    </p>
    <p>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     ; all other values are applied automatically depending on financials, flight dates, or missing attributes required for line item to serve. To understand the conditions that will cause a status to change, see <a href="/retail-media/docs/line-items#lifecycle">Line Item status</a>
    </p>
    <p>
     Accepted values:
     <code>
  ...
  <tr>
   ...
   <td>
    <p>
     ...
     , the line item status will remain unchanged along the weekdays and hours, as long as other delivery parameters are respected - see <a href="/retail-media/docs/line-items#lifecycle">Line Item status</a>
    </p>
    <p>
